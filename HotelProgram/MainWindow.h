...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Text = L"Зарезервовано";
			// 
			// button7
			// 
...
#pragma endregion
	...
	void WriteData(DataGridView^ dataGridView) {
		...
		dataGridView->Columns[5]->Name = "Ціна";
